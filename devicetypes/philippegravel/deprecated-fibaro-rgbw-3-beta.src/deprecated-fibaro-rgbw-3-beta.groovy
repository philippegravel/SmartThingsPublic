 ...
 *  Z-Wave RGBW Light
 *
 *  Author: Philippe Gravel with code of Todd Wackford
 *  Date: 2016-3-22
 */
...
metadata {
	definition (name: "Deprecated - Fibaro RGBW 3 Beta", namespace: "philippegravel", author: "Philippe Gravel") {
...
///////////////////        
		...
		standardTile("reset", "device.reset", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
			state "default", label:"Reset Color", action:"reset", icon:"st.Kids.kids2"
		}
		standardTile("refresh", "device.switch", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
			state "default", label:"", action:"refresh.refresh", icon:"st.secondary.refresh"
		}        

		standardTile("empty", "device.empty", width: 2, height: 2) { }
        
///// PHIL
//        valueTile("hexValueTile", "device.redLevel", decoration: "flat", height: 1, width: 2) {
//        	state "default", label:'#${hex(redLevel)}${hex(greenLevel)}${hex(blueLevel)}'
//        }     
    }
...
def reset() {
	...
	def result = []
/*    result << zwave.switchColorV3.switchColorSet(red: 255, green: 255, blue: 255)
   	sendEvent(name: "redLevel", value: 99)
    sendEvent(name: "greenLevel", value: 99)
    sendEvent(name: "blueLevel", value: 99)
    sendEvent(name: "whiteLevel", value: 99)*/
    
    result << zwave.switchColorV3.switchColorSet(red: 0, green: 0, blue: 0)
    result << zwave.switchColorV3.switchColorSet(warmWhite: 0, coldWhite: 0)
    sendEvent(name: "red", value: "off")
	sendEvent(name: "redLevel", value: 0)
    sendEvent(name: "green", value: "off")
    sendEvent(name: "greenLevel", value: 0)
    sendEvent(name: "blue", value: "off")
    sendEvent(name: "blueLevel", value: 0)
    sendEvent(name: "white", value: "off")
    sendEvent(name: "whiteLevel", value: 0)
    sendEvent(name: "switch", value: "off", displayed: true, isStateChange: true)
	commands(result)    
    state.previousHexLevels = ["red": "00", "green": "00", "blue": "00", "white": "00"]
}
